...
//import hr.abit.b3.biz.ib.bean.SecurityConstantsBean;
...
//import hr.abc.psd2.dto.ais.ConsentAisDto;
...
//@ViewScoped
//@Named
//public class PotpisConsentController extends WebCommons<ConsentAisDto, Integer> {
//
//	protected static final long serialVersionUID = 1L;
//
//	@EJB protected NalogTppBean nalogBean;
//	@Inject protected ConsentAisDao consentDao;
...
//	protected List<ConsentAisDto> odabraniConsenti = new ArrayList<ConsentAisDto>();
//	protected List<ConsentAisDto> nepotpisaniConsenti = new ArrayList<ConsentAisDto>();
//	protected List<ConsentAisDto> zaPovlacenje = new ArrayList<ConsentAisDto>();
//	protected List<ConsentAisDto> potpisaniConsenti = new ArrayList<ConsentAisDto>();
...
//
//
//	public PotpisConsentController() {
//		super(ConsentAisDto.class);
...
//			try {
//				utilBean.updateExpiredSmartPotpis(IBSmartPotpis.TIP_CONSENT_AIS);
...
//			List<AuthorizationDto> authorizationDto = authDao.getAuthorizationsByLink(refTppNaloga, Psd2Constants.AuthorizationObjectType.CONSENT_AUTHORIZATION.getValue());
...
//					List<ConsentAisDto> consentList = consentDao.getConsentAisBySifraList(tppSifraList);
//					//Provjera prava - za gradjane treba rijesiti da se automatski kreiraju prava ili ne provjeravati
//					if(utilBean.mozePotpisConsent(IBUsluga.USLUGA_POTPIS_CONSENTA, loginBean.getIbKorisnik().getSifra(), consentList)) {
//						if (consentList != null) {
//							for (ConsentAisDto consent : consentList) {
...
//		if(refTppNaloga != null && !StringUtils.isEmpty(refTppNaloga)){
//			AuthorizationDto authorizationDto = authDao.getAuthorizationByLink(refTppNaloga, Psd2Constants.AuthorizationObjectType.CONSENT_AUTHORIZATION.getValue());
//			if(authorizationDto != null)  {
...
//					ConsentAisDto consent = null;
//					try{
//						consent = consentDao.getConsentAisBySifra(authorizationDto.getObjectAuth());
//						if (consent != null) {
...
//
//	@Override
//	public GenericMinDao<?, ConsentAisDto, Integer> getGenericDao() {
//		return null;
//	}
//
//	@Override
//	public ConsentAisDto findDtoByPrimaryKey(String id) {
//		ConsentAisDto dto = null;
//		try{
//			dto = consentDao.getConsentAisBySifra(Integer.parseInt(id));
//		}catch(AbitRuleException ex){
//			dto = null;
//		}
...
//
//
//	public ConsentAisDto getNalog() {
//		return nalog;
//	}
//
//	public void setNalog(ConsentAisDto nalog) {
//		this.nalog = nalog;
//	}
//
...
//	}
//	public List<ConsentAisDto> getnepotpisaniConsenti() {
//		return nepotpisaniConsenti;
//	}
//
//	public void setnepotpisaniConsenti(List<ConsentAisDto> nepotpisaniConsenti) {
...
//	}
//
//	public List<ConsentAisDto> getZaPovlacenje() {
//		return zaPovlacenje;
//	}
//
//	public void setZaPovlacenje(List<ConsentAisDto> zaPovlacenje) {
...
//		odabraniConsenti = new ArrayList<ConsentAisDto>();
//		potpisaniConsenti = new ArrayList<ConsentAisDto>();
//		if(nepotpisaniConsenti != null) {
//			for (ConsentAisDto nalog : nepotpisaniConsenti) {
...
//			for (ConsentAisDto nalog : zaPovlacenje) {
//				if (nalog != null && nalog.isSelected()) {
//					odabraniConsenti.add(nalog);
//				}
//			}
...
//			}else {
//				odabraniConsenti = nalogBean.signConsenti(odabraniConsenti, loginBean.getIbGlobals(), loginBean.getIbKorisnik(), signId);
//
//				//Provjerimo greske i provjerimo broj knjizenih autorizacija
//				if (odabraniConsenti != null) {
//					int brojOk = 0;
//					for (ConsentAisDto nal : odabraniConsenti) {
...
//				Bassx2Message.addMessage(Bassx2Message.MessageType.INFO, poruka);
//			}else {
//				odabraniConsenti = nalogBean.povuciConsente(odabraniConsenti, loginBean.getIbGlobals(), loginBean.getIbKorisnik(), signId);
//
//				//Provjerimo greske i provjerimo broj knjizenih autorizacija
//				if (odabraniConsenti != null) {
//					int brojOk = 0;
...
//			}
//		} catch (AbitRuleException e) {
//			showError(InternationalizationUtil.getLocalMessage("povlacenjePrivola_error", new String[]{e.getMessage()}, GenericBassxConstants.Psd2.MESSAGE_BUNDLE));
//		}
//		redirectVisible = "true";
//	}
//
...
//			List<ConsentAisDto> oznaceni = new ArrayList<>();
//			brojOznacenihNaloga = 0;
//			pkiPotpis = "";
//			response = "";
//			for (ConsentAisDto nal : nepotpisaniConsenti) {
//				if (nal.isSelected()) {
//					brojOznacenihNaloga++;
//					oznaceni.add(nal);
...
//			}
//
//			for (ConsentAisDto nal : zaPovlacenje) {
//				if (nal.isSelected()) {
//					brojOznacenihNaloga++;
//					oznaceni.add(nal);
//					if(loginBean.getPrijava() instanceof WebPrijavaPKIKartica) pkiPotpis += new WebDigitalSignatureFootprint(nal).getFootprint();
...
//	}
//
//	public void potpisPkiNalog(ConsentAisDto webNalogDto){
////        try {
//		odabraniConsenti = new ArrayList<ConsentAisDto>();
...
//			hashPotpis = WebDigitalSignatureFootprint.getBase24Sign(new WebDigitalSignatureFootprint(odabraniConsenti, new Date(), false).getFootprint());
...
//	}
//
//	public void potpisSmartNalog(ConsentAisDto webNalogDto){
//		try {
//			naloziObradjeni = false;
//			odabraniConsenti = new ArrayList<ConsentAisDto>();
//			odabraniConsenti.add(webNalogDto);
...
//
//
//	public void potpisTokenNalog(ConsentAisDto webNalogDto, String appli2){
////        try {
//		odabraniConsenti = new ArrayList<ConsentAisDto>();
//		odabraniConsenti.add(webNalogDto);
//		setAppli2(appli2);
...
//			resolveodabraniConsenti();
//			Map<WebPrijava.UTILITY_OBJECT_ID, Object> mapObjects = resolveMapUtilData();
//			odabraniConsenti = loginBean.getPrijava().potpisiConsente(odabraniConsenti, mapObjects);
//			if(isPotpis) {
//				obradiConsente((String) mapObjects.get(WebPrijava.UTILITY_OBJECT_ID.SIGN_ID));
//			}else{
...
//			Map<WebPrijava.UTILITY_OBJECT_ID, Object> mapObjects = resolveMapUtilData();
//			odabraniConsenti = ((WebPrijavaUnsecured)loginBean.getPrijava()).potpisiConsente(odabraniConsenti, mapObjects);
//			if(isPotpis) {
//				obradiConsente((String) mapObjects.get(WebPrijava.UTILITY_OBJECT_ID.SIGN_ID));
//			}else{
//				povuciConsente((String) mapObjects.get(WebPrijava.UTILITY_OBJECT_ID.SIGN_ID));
...
//			List<ConsentAisDto> potpisaniNalozi = new ArrayList<>();
//			for(ConsentAisDto nalTmp : odabraniConsenti){
...
//	}
//
//	public List<ConsentAisDto> getOdabraniConsenti() {
//		return odabraniConsenti;
//	}
//
//	public void setOdabraniConsenti(List<ConsentAisDto> odabraniConsenti) {
