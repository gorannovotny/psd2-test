 ...
 *
 * PSD2 Confirmation of Founds (cof) Consent
 *
 */

@Entity
@Inheritance(strategy = InheritanceType.JOINED)
@Table(name = "psd2_consent_cof")
public class ConsentCof {
    //fields
    @Id
    ...
    @Column(name = "frequ_con")
    private Integer frequCon;   // Frequency Per Day
    @Column(name = "recur_con")
    ...
    @Column(name = "cdate_con")
    Timestamp cdateCon;     // Create datetime
    @Column(name = "todat_con")
    Date todatCon;     // Valid Until (Expire Date)
    @Column(name = "comsr_con")
    Integer comsr_Con;
    @Column(name = "tppfr_con")
