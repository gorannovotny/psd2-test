 ...
 *
 * PSD2 Acount Information Service (ais) Consent DTO
 *
 */
public class ConsentAisDto extends GenericDto<Integer> implements Serializable {
    ...
    private List<ConsentAccountAisDto> consentAccountAisDtoList;
    ...
    @IFilter(entityField = "ib.batzb_nal")
    private Integer sifraBatchBookingNaloga;
    private Boolean batchBooking;
    public ConsentAisDto() {
        super();
    }
...
//    }
    ...
    public List<ConsentAccountAisDto> getConsentAccountAisDtoList() {
        return consentAccountAisDtoList;
    }

    public void setConsentAccountAisDtoList(List<ConsentAccountAisDto> consentAccountAisDtoList) {
        this.consentAccountAisDtoList = consentAccountAisDtoList;
    }
...
//        }
    ...
    public String getTipConsenta() {
        return tipConsenta;
    }

    public void setTipConsenta(String tipConsenta) {
        this.tipConsenta = tipConsenta;
    }
    ...
    public Boolean getMozePotpisPovlacenja() {
    ...
    public Integer getSifraBatchBookingNaloga() {
        return sifraBatchBookingNaloga;
    }

    public void setSifraBatchBookingNaloga(Integer sifraBatchBookingNaloga) {
        this.sifraBatchBookingNaloga = sifraBatchBookingNaloga;
    }
}
